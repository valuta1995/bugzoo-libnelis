...
{
    mcp.reset();
    mcp.config( (MCP_GPB_DIR<<8) | MCP_GPA_DIR, (MCP_GPB_PULL<<8) | MCP_GPA_PULL, (MCP_GPB_POL<<8) | MCP_GPA_POL);      // Config direction, pullups and polarity
...
void freedom_adc_init()
{
    // TODO - those damn ADC pins and their hardfaults
    adc_init();
}
